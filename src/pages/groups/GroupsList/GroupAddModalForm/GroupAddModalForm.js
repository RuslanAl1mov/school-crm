...
const GroupAddModalForm = ({ isOpen, onClose }) => {
        ...
        <div className="modal-overlay" onClick={handleOverlayClick}>
            <div className="modal-content">
                <div className="modal-header">
                    <h5>Добавить новую группу</h5> {/* Updated title */}
                ...
                <div className="modal-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="set-password-link-block">
                            {!showAddToGroupField && (
                                <a href="#" onClick={handleAddToGroupClick} className="set-password-link">
                                    + Добавить в группу
                                </a>
                            )}
                        </div>

                        {/* Поля добавления в группу */}
                        {showAddToGroupField && (
                            <div className="form-group">
                                <label htmlFor="group">Группа</label> {/* Updated label */}
...
export default GroupAddModalForm; // Updated export
